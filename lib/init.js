...
ep.addExtract(/\bseason\W+\d{1,2}\W+episode\W+(\d{2,3})\W/i, 80); // "season 01 episode 01"
ep.addExtract(/\bseason\W+(?:19|20)\d\d\W+episode\W+(\d{2,3})\W/i, 80); // "season 1980 episode 01"
...
season.addExtract(/\bseason\W+(\d{1,2})\W+episode\W+\d{2,3}\b/i, 80); // "season 01 episode 01"
season.addExtract(/\bseason\W+((?:19|20)\d\d)\W+episode\W+\d{2,3}\b/i, 80); // "season 1980 episode 01"
