...
ep.addExtract(/s(?:19|20)\d\de(\d{1,2})/i, 90); // "s1980e01"
ep.addExtract(/s\d{1,2}xe(\d{1,2})/i, 90);      // "S01xE01"
ep.addExtract(/s(?:19|20)\d\dxe(\d{1,2})/i, 90);// "S1980xE01"
ep.addExtract(/\bseason\W+\d{1,2}\W+episode\W+(\d{1,2})\W/i, 80); // "season 01 episode 01"
ep.addExtract(/\bseason\W+(?:19|20)\d\d\W+episode\W+(\d{1,2})\W/i, 80); // "season 1980 episode 01"
ep.addExtract(/\bepisode\W+(\d{1,3})\W/i, 70);  // "episode 01" or "episode 001"
ep.addExtract(/s\d{1,2}\We(\d{1,2})/i, 80);     // "s01 e01"
ep.addExtract(/s(?:19|20)\d\d\We(\d{1,2})/i, 80); // "s1980 e01"
...
season.addExtract(/s((?:19|20)\d\d)e\d{1,2}/i, 90); // "s1980e01"
season.addExtract(/s(\d{1,2})xe\d{1,2}/i, 90);      // "S01xE01"
season.addExtract(/s((?:19|20)\d\d)xe\d{1,2}/i, 90);// "S1980xE01"
season.addExtract(/\bseason\W+(\d{1,2})\W+episode\W+\d{1,2}\b/i, 80); // "season 01 episode 01"
season.addExtract(/\bseason\W+((?:19|20)\d\d)\W+episode\W+\d{1,2}\b/i, 80); // "season 1980 episode 01"
season.addExtract(/s(\d{1,2})\We\d{1,2}/i, 80);      // "s01 e01"
season.addExtract(/s((?:19|20)\d\d)\We\d{1,2}/i, 80);// "s1980 e01"
season.addExtract(/\bS(\d\d)\b/, 60);               // " S01 "
season.addExtract(/\bS((?:19|20)\d\d)\b/, 60);      // " S1980 "
season.addExtract(/\b(\d)x\d\d\b/, 50);             // " 1x01 "
season.addExtract(/\b((?:19|20)\d\d)x\d\d\b/, 50);  // " 1980x01 "
...
season.addExtract(/((?:19|20)\d\d)x\d\d\b/, 6);  // "1980x01 "
